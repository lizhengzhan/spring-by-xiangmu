...
public class OssUpFileUtil {
     ...
     */
    private static String accessKeyId = "LTAI3Rz59UnlEhWp";
    private static String accessKeySecret = "evuV7Mus1aavAroVcev88049UNavav";
    /**
     * Bucket命名规范如下：只能包括小写字母，数字和短横线（-），必须以小写字母或者数字开头，长度必须在3-63字节之间。
     */
    private static String bucketName = "gupi";
    /**
     * OSS文件夹名称
     */
    private static String firstHost = "kang";
    /**
